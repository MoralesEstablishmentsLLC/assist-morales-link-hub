      ...
      <section className="relative py-32 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <motion.h1 className="text-6xl md:text-7xl font-display font-bold mb-6" initial={{
            opacity: 0,
            y: 20
          }} animate={{
            opacity: 1,
            ...
            <motion.p className="text-xl md:text-2xl mb-12 max-w-3xl mx-auto text-muted-foreground" initial={{
            opacity: 0,
            y: 20
          }} animate={{
            opacity: 1,
            ...
            delay: service.delay
                ...
                <Card className="h-full hover-lift hover:shadow-glow border-${service.color}-500/20 group cursor-pointer">
                  <CardHeader className="text-center">
                    <motion.div className={`bg-brand-${service.color}/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4`} whileHover={{
                  scale: 1.1,
                  rotate: 5
                }} transition={{
                  type: "spring",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div ref={benefitsRef} className="space-y-4">
                <div className={`flex items-start gap-3 transition-all duration-700 ${benefitsVisible ? 'opacity-100 translate-y-0 delay-200' : 'opacity-0 translate-y-4'}`}>
                ...
                <div className={`flex items-start gap-3 transition-all duration-700 ${benefitsVisible ? 'opacity-100 translate-y-0 delay-500' : 'opacity-0 translate-y-4'}`}>
                  <CheckCircle className="w-6 h-6 text-primary mt-1" />
                  <div>
                ...
                <div className={`flex items-start gap-3 transition-all duration-700 ${benefitsVisible ? 'opacity-100 translate-y-0 delay-700' : 'opacity-0 translate-y-4'}`}>
                  <CheckCircle className="w-6 h-6 text-primary mt-1" />
                  <div>
              ...
              delay: 0.1
                ...
                <Card className="shadow-card hover-lift glass-card">
                  <CardContent className="pt-6">
                    ...
                    <MetricsCounter end={7} label="Happy Clients" />
                  </CardContent>
                </Card>
              </motion.div>
              ...
              delay: 0.4
                ...
                <Card className="shadow-card hover-lift glass-card">
                  <CardContent className="pt-6">
                    ...
                    <MetricsCounter end={7} label="Businesses Served" />
                  </CardContent>
                </Card>
              </motion.div>
            </div>
